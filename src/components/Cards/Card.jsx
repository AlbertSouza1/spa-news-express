import { CardBody, CardContainer, CardFooter, CardInfo, LinksWrapper } from "./CardStyled";
        ...
        <CardContainer>
            ...
            <CardBody variant={props.variant}>
                {actions
                    &&
                    <LinksWrapper>
                        <Link to={`/manage-news/edit/${props.id}`} title="Editar notícia">
                ...
                <TextLimited text={props.text} limit={180} />
            </CardBody>
